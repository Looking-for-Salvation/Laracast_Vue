	...
	<div>
		<main>
			...
			<div>
							...
							>
								<div class="text-white lg:mx-auto lg:mt-[93px] lg:text-center">
									<figure class="text-center md:text-right lg:text-center font-IranSans">
										<img src="@/assets/images/taylor@2x.webp" alt="Taylor Otwell" class="mix-blend-luminosity" width="138" height="143" />
								...
								<img
									src="@/assets/images/laracasts-gang.svg"
				...
				<section class="text-white" style="background-image: linear-gradient(to right, rgb(91, 121, 162), rgb(46, 68, 105));"></section>
			</div>
		</main>
	</div>
</template>
