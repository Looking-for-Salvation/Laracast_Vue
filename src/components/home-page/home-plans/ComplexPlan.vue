<template>
	<div class="mx-0 team-plan-wrap">
		<div class="relative flex w-auto h-full px-4 py-5 text-center bg-white plan card rounded-xl max-w-none">
			<div class="flex flex-col justify-around w-full h-full team-plan-left" style="flex: 2 1 0%;">
				...
				<router-link :to="planRoute" class="flex justify-center">
					<img :src="planImg" :alt="planName" width="165" height="120" />
				</router-link>
				<p class="px-2 my-4 mb-8 text-black font-IranSans">
			...
			<div class="flex-1 h-full pr-6">
				<div class="flex flex-row h-full thermometer-wrap">
					...
					<div class="relative flex flex-col-reverse justify-around w-full mr-3 thermometer-legend">
