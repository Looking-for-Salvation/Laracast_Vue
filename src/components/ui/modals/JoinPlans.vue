	...
	<base-modal inlineStyles="width: 1200px; max-width: 90vw;" :isVisible="isVisible" @close="closeModal">
		<div class="flex flex-col justify-between h-full px-4">
			<div class="flex-1 w-full px-10">
				<div class="mb-auto">
					<div v-if="isJoinVisible">
						<div class="mx-auto">
							<div class="flex">
								<div class="w-3/4 mx-auto mb-8 text-center">
									<div class="mb-8">
					...
					<div v-if="isFAQVisible" class="mx-auto">
						<div class="w-3/4 mx-auto mb-12 text-center text-black">
							<h1 class="mb-4 text-4xl font-light tracking-tight font-IranSans">سوال های پرتکرار</h1>
						</div>
			...
			<div class="relative text-center border-t border-solid border-opacity-10">
				<div class="grid grid-cols-3 gap-6 mt-10">
					<div class="flex justify-end ml-auto w-38">
						<button v-if="isJoinVisible" class="inline-flex items-center text-black font-IranSans hover:text-blue-400" @click="faq">
						...
						<button v-if="isFAQVisible" class="inline-flex items-center text-black font-IranSans hover:text-blue-400" @click="plans">
							<span class="inline-block p-2 bg-gray-100 rounded-xl">
								<svg viewBox="0 0 20 20" class="w-6" data-v-2836fdb5-s="">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" data-v-2836fdb5-s="">
										<g class="fill-current" data-v-2836fdb5-s="">
...
import PersonalPlans from "../../home-page/home-plans/PersonalPlans.vue";
import TeamsPlans from "../../home-page/home-plans/TeamsPlans.vue";
